class CreateCategoryPanel {
    constructor(options = {}) {
        ...
        this.selectedIcon = 'fa-solid fa-star';
    ...
    _createPanel() {
        ...
        this.panel.className = 'create-category-panel';
    ...
    _createNameSection() {
        ...
        this.nameInput.placeholder = 'Enter category name';
    ...
    _createIconSection() {
        ...
        style.textContent = `
            .create-category-panel .icon-picker::-webkit-scrollbar {
                display: none;
            }
        `;
        iconPickerContainer.className = 'icon-picker';
        if (!document.querySelector('style[data-icon-picker-scroll]')) {
            style.setAttribute('data-icon-picker-scroll', 'true');
            document.head.appendChild(style);
        }
        
        // Common icons from font-awesome
        const icons = [
            'fa-solid fa-briefcase', 'fa-solid fa-heart', 'fa-solid fa-dumbbell',
            'fa-solid fa-graduation-cap', 'fa-solid fa-shopping-bag', 'fa-solid fa-plane',
            'fa-solid fa-users', 'fa-solid fa-wallet', 'fa-solid fa-palette',
            'fa-solid fa-home', 'fa-solid fa-calendar', 'fa-solid fa-star',
            'fa-solid fa-book', 'fa-solid fa-music', 'fa-solid fa-gamepad',
            'fa-solid fa-camera', 'fa-solid fa-car', 'fa-solid fa-utensils'
        ];
